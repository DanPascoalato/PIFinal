...
function draw() {
    ...
    tabela([quantiA, quantiB, quantiC]);
    CalculaA();
    checaA = quantiA;
    quantiA = salvaA;
    CalculaB();
...
function CalculaA(){
    ...
    salvaA = quantiA + timeStep * (k1 + 2*k2 + 2*k3 + k4) / 6;
}
...
function CalculaB(){
    ...
    salvaB = quantiB + timeStep * (l1 + 2*l2 + 2*l3 + l4) / 6;
}
...
function CalculaC(){
    ...
    salvaC = quantiC + timeStep * (m1 + 2*m2 + 2*m3 + m4) / 6;
